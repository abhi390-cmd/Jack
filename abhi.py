...
#    pass
#else:
#    print(f'{r}{C}[{N}+{C}]{N} TOOLS STOPPED FOR PREMIUM VERSION DM @T_65F')
#    exit()
WDEH = render('ARIHABI', colors=['white', 'cyan'], align='center')
print(WDEH)
print('')
print(('\x1b[38;5;48m—'*40)+'\n• ARIHABI\n'+('—'*40))
ID = input(f"{C}[{N}→{C}] {N}Enter your Id: {r}")
print('')
print(('\x1b[38;5;48m—'*40)+'\n• ARIHABI\n'+('—'*40))
token = input(f"{C}[{N}→{C}] {N}Enter your Token: {r}")
def Users():
    global Ex
    try:
...
def fg(id):
    ...
    exit()	
print(f"""ARIHABI\n
{r}[{N}1{C}]{r}{bbo} ->   {C}𝗖𝗵𝗲𝗰𝗸{N} 𝗣𝗹𝗮𝗰𝗲 {r}

[{N}2{C}]{r}{bbo} -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}𝗣𝗹𝗮𝗰𝗲  {r}

[{N}3{C}]{r}{bbo} ->   {C}𝗗𝗲𝗹𝗲𝘁𝗲 {N}𝗟𝗶𝘀𝘁 {r}

[{N}4{C}]{r}{bbo} ->   {C}𝗗𝗲𝘃𝗲𝗹{N}𝗹𝗼𝗽𝗲𝗿 {r}
""")
try:
 print(('\x1b[38;5;48m—'*40)+'\n• ARIHABI\n'+('—'*40))
...
if egi == 1:
    try:requests.get(f"https://api.telegram.org/bot{token}/sendvideo?chat_id={ID}&video=https://t.me/HRTYQ/6&caption=ARIHABI 🧉\n\n@HRTYQ 🔥")
    except:pass
    pass
elif egi == 2:
    print(('\x1b[38;5;48m—'*40)+'\n• ARIHABI\n'+('—'*40))
    print(f"""
    {r}[{N}1{C}] -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}2011
    [{N}2{C}] -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}2012
    [{N}3{C}] -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}2013
    [{N}4{C}] -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}14-23
    [{N}5{C}] -> {C}  𝗚𝗲𝘁 𝗟𝗶𝘀𝘁 {N}𝗙𝗿𝗼𝗺 𝗨𝘀𝗲𝗿
    """)
    print(('\x1b[38;5;48m—'*40)+'\n• ARIHABI\n'+('—'*40))
    ...
    if f1 == 1:
        webbrowser.open('https://t.me/vbkhpu880')
        exit()
    elif f1 == 2:
      webbrowser.open('https://t.me/vbkhpu880')
      exit()
